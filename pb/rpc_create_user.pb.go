...
const file_rpc_create_user_proto_rawDesc = "" +
	"\n" +
	"\x15rpc_create_user.proto\x12\x02db\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\n" +
	"user.proto\"~\n" +
	...
	"\x04user\x18\x01 \x01(\v2\b.db.UserR\x04userB\x0fZ\rsimplebank/pbb\x06proto3"
